...
- [ ] In a separate terminal cd into the `project` folder and run `yarn install` to download dependencies.
- [ ] Still inside the `project` folder run `yarn start` to run the client application.
